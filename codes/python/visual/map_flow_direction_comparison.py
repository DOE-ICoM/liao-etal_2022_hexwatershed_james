...
fig, axs = plt.subplots(nrow, ncolumn, figsize=(13, 12), dpi=300)
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2022_hexwatershed_james/code/python/visual/flow_direction_comparison.png'
#plt.show()
