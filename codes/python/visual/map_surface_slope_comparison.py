...
sFilename_png = 'surface_slope.png'
dValue_min=0
dValue_max=0.1
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2022_hexwatershed_james/code/python/visual/surface_slope_comparison.png'
#plt.show()
